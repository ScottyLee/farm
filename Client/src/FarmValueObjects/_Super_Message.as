...
{
import FarmValueObjects.Status_type;
...
[ExcludeClass]
public class _Super_Message extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        FarmValueObjects.Status_type.initRemoteClassAliasSingleChild();
    }
     ...
     * properties
     */
    private var _internal_Status : FarmValueObjects.Status_type;
    ...
    public function get Status() : FarmValueObjects.Status_type
    {
    ...
    public function set Status(value:FarmValueObjects.Status_type) : void
    {
        var oldValue:FarmValueObjects.Status_type = _internal_Status;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfStatus : FarmValueObjects.Status_type;

    model_internal function _doValidationForStatus(valueIn:Object):Array
    {
        var value : FarmValueObjects.Status_type = valueIn as FarmValueObjects.Status_type;
